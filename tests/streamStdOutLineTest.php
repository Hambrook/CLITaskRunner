 ...
 */
class streamStdOutLineTest extends PHPUnit_Framework_TestCase {
	...
	public function testOnLineMock($object) {
		...
		$object->onLine("stdOut", [$mock, "validateThree"], "/three/");
	...
	public function testOnLineLocal($object) {
		...
		$object->onLine("stdOut", [$this, "validateThree"], "/three/");
